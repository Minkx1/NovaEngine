# This is source-code of game - Labyrinth Crawler
import sys, os
sys.path.append(os.path.dirname(os.path.dirname(__file__))) # making python see novaengine module in lower dir.
